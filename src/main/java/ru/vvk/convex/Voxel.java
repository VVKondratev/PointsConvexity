...
public class Voxel {
	...
	//Тестирование функции поворота
	static{
		final int[] src = {0, 1, 2, 3, 4, 5, 6, 7}; //Начальное - тождественное преобразование
		
		for(int i = 0; i < rotates.length; i++) {
			int[] dst = rotate(src, i, 4);
			if(!Arrays.equals(src, dst)) {
				throw new RuntimeException("Поворот на 360 вдоль оси "+ i +" не тождественен исходному состоянию");
			}
		}
	}
	...
	static {
		...
		//System.out.println(Arrays.deepToString(transforms));
...
//		addCase(new int[]{1,1,1,1,1,1,1,1}, h -> 0d, new int[][][] {});
//		addCase(new int[]{1,0,0,0,0,0,0,0}, h -> h*h/8d, new int[][][] {{{0,1}, {0,4}, {0,2}}});
//		addCase(new int[]{1,1,0,0,0,0,0,0}, h -> h*h/Math.sqrt(2), new int[][][] {{{0,4}, {1,5}, {1,3}, {0,2}}});
//		addCase(new int[]{1,1,0,0,1,1,0,0}, h -> h*h, new int[][][] {{{0,2}, {1,3}, {5,7}, {4,6}}});
//		addCase(new int[]{1,0,0,1,0,0,0,0}, h -> h*h/4, new int[][][] {{{0,1}, {0,4}, {0,2}}, {{1,3}, {3,7}, {2,3}}});
//		addCase(new int[]{1,0,0,1,0,0,0,1}, h -> h*h/(1d/8 + 1/Math.sqrt(2)), new int[][][] {{{0,1}, {0,4}, {0,2}}, {{1,3}, {5,7}, {6,7}, {2,3}}});
//		addCase(new int[]{1,1,0,0,0,0,1,1}, h -> Math.sqrt(2)*h*h, new int[][][] {{{0,2}, {1,3}, {1,5}, {0,4}}, {{2,6}, {3,7}, {5,7}, {4,6}}});
//		addCase(new int[]{1,0,0,0,0,0,0,1}, h -> h*h/4d, new int[][][] {{{0,1}, {0,4}, {0,2}}, {{5,7}, {6,7}, {3,7}}});
//		addCase(new int[]{1,1,0,0,0,1,0,0}, h -> h*h, new int[][][] {{{0,2}, {1,3}, {5,7}, {4,6}}});
//		addCase(new int[]{1,0,0,0,0,1,1,0}, h -> 3*h*h/8d, new int[][][] {{{0,1}, {0,4}, {0,2}}, {{2,6}, {4,6}, {6,7}}, {{4,5}, {1,5}, {5,7}}});
//		
//		addCase(new int[]{1,1,1,0,1,0,0,0}, h -> -1d, new int[][][] {{{4,5}, {4,6}, {2,6}, {2,3}, {1,3}, {1,5}}});
//		addCase(new int[]{0,0,0,1,1,0,1,1}, h -> -1d, new int[][][] {});
//		addCase(new int[]{0,0,0,1,1,1,0,1}, h -> -1d, new int[][][] {});
//		addCase(new int[]{0,0,0,1,1,1,1,0}, h -> -1d, new int[][][] {});
//		addCase(new int[]{0,1,1,0,1,0,0,1}, h -> h*h/2d, new int[][][] {{{0,1}, {0,4}, {0,2}}, {{1,5}, {4,5}, {5,7}}, {{2,3}, {1,3}, {3,7}}, {{2,6}, {6,7}, {4,6}}});
//		
	...
	public Function<Double, Double> getS(){return this.s;}
